...
main() {
  ...
  # readonly show_session=" #S #{?client_prefix,#[bg=$thm_red],#[bg=$thm_green]}#[fg=$thm_bg0]  #[fg=$thm_fg,bg=$thm_bg2]#[fg=$thm_green]#[bg=$thm_bg2]"
  readonly show_session=" #S #[bg=$thm_green,fg=$thm_bg0]  #[fg=$thm_green,bg=$thm_bg2]"
