...
main() {
  ...
  readonly show_directory="#[fg=$thm_aqua,bg=$thm_bg0,nobold,nounderscore,noitalics]🭦#[fg=$thm_bg0,bg=$thm_aqua,nobold,nounderscore,noitalics]     #[fg=$thm_fg,bg=$thm_bg2] #{b:pane_current_path} #{?client_prefix,#[fg=$thm_red]"
